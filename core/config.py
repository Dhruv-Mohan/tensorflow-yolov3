...
# Set the class name
__C.YOLO.CLASSES                = "/media/dhruv/Blue22/Blue2/downloads/yolov3/output/class.names"
...
__C.TRAIN.ANNOT_PATH            = "/media/dhruv/Blue22/Blue2/downloads/yolov3/output/dataset.txt"
